...
Drainage density : Flood hazard is proportionally related to drainage density because higher drainage
...
The district-wise mean values of flood hazard can be extracted from the flood hazard zoning map. The assam_district_27 shapefile shows 27 districts. The shapefile can be replaced by [updated Assam district shapefile](https://drive.google.com/drive/folders/1b5FePztSJFQcKogcovCcGKbBJVTYcREy).
